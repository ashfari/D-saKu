...
import com.project.d_saku.Adapter.VerifikasiListUserAdapter;
...
public class VerifikasiListUserActivity extends AppCompatActivity implements VerifikasiListUserAdapter.dataListener {
    ...
    private void GetData(){
        ...
        reference.child("verifikasi").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new VerifikasiListUserAdapter(verifikasis, VerifikasiListUserActivity.this, usernameMessage, passwordMessage, idJabatanMessage, nikMessage, userDetails);
    ...
    public void onDeleteData(Verifikasi data, int position) {
        if(reference != null){
            reference.child("verifikasi").child(data.getIdVerifikasi()).removeValue()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                    Toast.makeText(VerifikasiListUserActivity.this, "Data Berhasil Dihapus", Toast.LENGTH_SHORT).show();
                    }
                });
        }
    }
