...
public class PemberitahuanActivity extends AppCompatActivity implements PemberitahuanSuratAdapter.dataListener {
        ...
        reference.child("suratPengantarNikah").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if (pemberitahuan.getStatus().equals(namaJabatan) && currentUser.getNamaKelurahan().equals(pemberitahuan.getNamaKelurahan())
                ...
                adapter = new PemberitahuanSuratAdapter(pemberitahuanSurats, PemberitahuanActivity.this, usernameMessage, passwordMessage, idJabatanMessage, nikMessage);
        ...
        if(reference != null){
            reference.child("suratPengantarNikah").child(data.getNomorSurat()).removeValue()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    Toast.makeText(PemberitahuanActivity.this, "Data Berhasil Dihapus", Toast.LENGTH_SHORT).show();
                    }
                });
        }
    }
