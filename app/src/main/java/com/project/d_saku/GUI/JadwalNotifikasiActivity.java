...
public class JadwalNotifikasiActivity extends AppCompatActivity implements JadwalNotifikasiAdapter.dataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jadwal_notifikasijadwal);
        ...
        recyclerView = findViewById(R.id.notifikasiJadwalList);
        ...
        reference.child("jadwal").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if (usernameMessage.equals(jadwal.getDariUsername())){
                        jadwals.add(jadwal);
                    }
                    else if (!usernameMessage.equals(jadwal.getDariUsername())&& namaJabatan.equals(jadwal.getKeJabatan())){
                        if (jadwal.getStatusJadwal().equals("Terkirim")){
                            jadwals.add(jadwal);
                        }
                    }
                }
                adapter = new JadwalNotifikasiAdapter(jadwals, JadwalNotifikasiActivity.this, usernameMessage, passwordMessage, idJabatanMessage, nikMessage, userDetails);
        ...
        if(reference != null){
            reference.child("jadwal").child(data.getIdJadwal()).removeValue()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    Toast.makeText(JadwalNotifikasiActivity.this, "Data Berhasil Dihapus", Toast.LENGTH_SHORT).show();
                    }
                });
        }
    }
