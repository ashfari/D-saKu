...
public class PemberitahuanSuratAdapter extends RecyclerView.Adapter<PemberitahuanSuratAdapter.ViewHolder>{
    ...
    public PemberitahuanSuratAdapter(ArrayList<SuratPengantarNikah> listPemberitahuan, Context context, String usernameMessage, String passwordMessage, String idJabatanMessage, String nikMessage) {
        ...
        listener = (PemberitahuanActivity)context;
    }
