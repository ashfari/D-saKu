...
public class VerifikasiNotifikasiAdapter extends RecyclerView.Adapter<VerifikasiNotifikasiAdapter.ViewHolder>{
    ...
    public VerifikasiNotifikasiAdapter(ArrayList<Verifikasi> listVerifikasi, Context context, String usernameMessage, String passwordMessage, String idJabatanMessage, String nikMessage, ArrayList<UserDetail> userDetails) {
        ...
        listener = (VerifikasiNotifikasiActivity)context;
    }
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        switch (i){
                            case 0:
                                ...
                                reference.child("verifikasi").child(listVerifikasi.get(position).getDariVerifikasi())
